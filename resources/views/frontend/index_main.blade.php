...
@foreach ($all_publish_product as $item)
<div class="col-sm-4">
    <div class="product-image-wrapper">
                ...
                <div class="product-overlay">
                    <div class="overlay-content">
                        ...
                        <form action="{{url("/add-to-cart/".$item->id)}}" method="POST">
                            ...
                            <button type="submit" class="btn btn-default add-to-cart" class="fa fa-shopping-cart">
        ...
        <div class="choose">
            <ul class="nav nav-pills nav-justified">
                ...
                <li><a href="{{URL::to("/pruduct-view/".$item->id)}}"><i class="fa fa-plus-square"></i>View Product</a></li>
            </ul>
        </div>
    </div>
</div>
