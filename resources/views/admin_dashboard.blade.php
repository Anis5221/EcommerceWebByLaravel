			...
			<div class="container-fluid">
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i>{{Session::get('admin_name')}} {{Session::get('admin_id')}}
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{url("/log-out")}}"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
					    ...
					    <li><a href="{{URL::to('/all-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet">All Categorys</span></a></li>
						<li><a href="{{URL::to("/add-category")}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="{{URL::to("/all-manufecture")}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufecture</span></a></li>
						<li><a href="{{URL::to("/add-manufecture")}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Manufecture</span></a></li>
						<li>
							<a class="" href="{{URL::to("/all-product")}}"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> All Products</span><span class="label label-important"> 3 </span></a>
	...
	<!-- start: JavaScript-->
		...
		<script>
			$('#myModal2').on('shown.bs.modal', function (event) {
				console.log('model id opened');
				var button = $(event.reletedTerget);
			//	var name = 
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
  ...
  var des = button.data('des') // Extract info from data-* attributes
